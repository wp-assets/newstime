                            ...
                            <div class="post-widget light-shadow white-bg">
                                ...
                                <article class="post">
                                    ...
                                    <div class="post-thumb"> 
                                        <?php the_post_thumbnail('single_post', array('class'=>''));?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <ul class="post-meta">
                                                        ...
                                                        <li><i class="fa fa-comments-o"></i><?php comments_popup_link('No Comment', '1 Comment', '% Comments');?></li>
                                                    </ul>
                                                    <!-- post meta -->
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <div class="light-shadow gray-bg p-30"> 
                                    ...
                                    ?>
                                        ...
                                        <div class="post style-1">
                                            ...
                                            <!-- thumbnail -->
                                            <div class="post-thumb"> 
                                                <?php the_post_thumbnail('related_post', array('class'=>'related_image'));?>
                                                <span class="post-badge"><?php the_category(); ?></span>
